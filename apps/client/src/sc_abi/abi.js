export const PatientPortABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string", name: "fromSpecial", type: "string" },
      { internalType: "string", name: "fromEmail", type: "string" },
      { internalType: "address", name: "to", type: "address" },
      { internalType: "string", name: "toName", type: "string" },
      { internalType: "string", name: "toSpecial", type: "string" },
      { internalType: "string", name: "toEmail", type: "string" },
